...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.8f893082c2416fd7a34964689c914ba50b3fa9096dffa8f23c4197f0df562d6d.js',function(){input.required=false;search();});}
