...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.f5002dc237d7f2ffe15a5d7029b5f8fd4fcda32c152132c0b5d3a044eb283fe6.js',function(){input.required=false;search();});}
