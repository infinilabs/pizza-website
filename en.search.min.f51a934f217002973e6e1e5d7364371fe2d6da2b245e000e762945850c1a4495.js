...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.037d8229575f923dafe199da92051e91b8d6debf6f269a0d7788069e7bb39059.js',function(){input.required=false;search();});}
